...
int main()
{
	const char *intro = "RMS is a coder out to destroy proprietary software. Balmer (the anti-hero) dose not share RMS's philosophy and aims to silence RMS."
		"\n########intro#########"
  ...
  // sleep(2);
  // cout << "Shota-Linus rolls you out of bed. You then command him to boot up your Lemote Yeeloong." << endl;
  // sleep(2);
  // cout << "He protests that it will take forever, but he does it anyways." << endl;
  // sleep(2);
  // cout << "After 30 minutes of waiting, the ancient machine displays a faint gNewSense logo on its greasy display." << endl;
  // sleep(2);
  ...
  // cout << "The constant tugging on your beard eventually annoys you, and you" << endl;
	...
	sleep(2);
	printf("\n>discus what happened and wonder what should be done about it.");
	sleep(2);
	printf("\n>");
  return 0;
}
