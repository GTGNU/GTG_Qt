...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("../../../../../../Users/Danny/Pictures/4chan/GTG/icon.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        centralWidget->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/Grand-Theft-Gentoo-master/Info/Artwork/Wallpaper.jpg);"));
        ...
        QPalette palette;
        QBrush brush(QColor(8, 255, 45, 255));
        ...
        QFont font;
        font.setFamily(QStringLiteral("MizuFontAlphabet"));
        font.setPointSize(14);
        font.setBold(false);
        font.setWeight(50);
        pushButton_3->setFont(font);
        pushButton_3->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/Grand-Theft-Gentoo-master/Info/Artwork/none.jpg);"));
        ...
        pushButton_2->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/Grand-Theft-Gentoo-master/Info/Artwork/none.jpg);"));
        ...
        QFont font1;
        font1.setFamily(QStringLiteral("MizuFontAlphabet"));
        ...
        pushButton->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix1/Grand-Theft-Gentoo-master/Info/Artwork/none.jpg);"));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Grand Theft Gentoo", 0));
